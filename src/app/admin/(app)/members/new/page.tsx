    ...
    <div className="max-w-xl mx-auto space-y-6">
      ...
      {error && (
        <div className="rounded-lg bg-red-50 text-red-700 px-4 py-3 ring-1 ring-red-200">
          {error === "missing" && "All required fields must be completed."}
      ...
      >
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">Required. Australian mobile.</p>
        </div>

        <div>
          <label className="block text-sm font-medium">RFID tag (optional)</label>
          <input
            name="rfidTag"
